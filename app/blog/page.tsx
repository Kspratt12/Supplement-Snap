...
const ARTICLES = [
  ...
  { slug: "how-much-do-roofing-supplements-pay", title: "How Much Do Roofing Supplements Pay? Real Numbers", desc: "Real revenue data on average supplement values, what gets approved, and how to maximize recovery per job.", date: "2026-03-14" },
  ...
  { slug: "roof-tear-off-cost", title: "Roof Tear-Off Cost in 2026: What Contractors and Homeowners Should Know", desc: "Breakdown of roof tear-off costs by size, material, and pitch, plus hidden costs discovered during tear-off and how supplements recover them.", date: "2026-03-20" },
  { slug: "best-roof-estimating-software", title: "Best Roof Estimating Software for Contractors in 2026", desc: "Compare satellite measurement, estimating, CRM, and supplement tools. What to look for and how they work together.", date: "2026-03-21" },
  { slug: "hail-damage-roof-inspection", title: "Hail Damage Roof Inspection: What Gets Missed and How to Document It", desc: "How to inspect for hail damage, what adjusters miss, hidden damage found during tear-off, and how to document for supplements.", date: "2026-03-22" },
  ...
  { slug: "xactimate-roof-estimate-supplements", title: "How to Build an Xactimate Roof Estimate for Insurance Supplements", desc: "Key line codes, pricing benchmarks, and common mistakes, plus how to format supplements so adjusters approve them fast.", date: "2026-03-24" },
  { slug: "roof-replacement-estimate-vs-final-cost", title: "Roof Replacement Estimate vs. Final Cost: Why Supplements Close the Gap", desc: "Why the initial estimate is always lower, what gets missed, and how supplements bridge the gap between estimate and actual cost.", date: "2026-03-25" },
]
